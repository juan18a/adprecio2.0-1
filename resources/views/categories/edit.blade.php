...
@section('content')
  ...
  <form   method="post" action="{{ route('categories.update', $cat->id) }} enctype="multipart/form-data" class="form-horizontal" >
        ...
        @csrf
                      <div class="col col-md-3"><label for="text-input" class=" form-control-label">Categoria</label></div>
                        <div class="col-12 col-md-9">
                             ...
                             <input type="text" id="text-input" value={{$cat->category}} name="categoria" autocomplete="off" placeholder="Categoria" class="form-control">
